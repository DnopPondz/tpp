...
function ListCard({ title, items, columnsClass = "" }) {
  return (
    <div className="space-y-4 rounded-3xl border border-border-subtle bg-background p-8 shadow-sm transition-colors duration-300">
...
function DetailCard({ title, description }) {
  return (
    <div className="space-y-3 rounded-3xl border border-border-subtle bg-surface-muted/60 p-8 text-sm text-foreground shadow-sm transition-colors duration-300">
  ...
  return (
    <div className="theme-surface">
      <div className="mx-auto max-w-6xl space-y-16 px-6 pb-24 pt-20 lg:px-8">
        <header className="space-y-6 rounded-[3rem] border border-border-subtle bg-background p-10 text-center shadow-2xl transition-colors duration-300 lg:text-left">
          <span className="inline-flex items-center gap-2 rounded-full bg-surface-muted px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-blue-700 shadow">
        ...
        <section className="grid gap-8 rounded-[3rem] border border-border-subtle bg-background p-10 shadow-xl transition-colors duration-300 lg:grid-cols-[1.2fr_1fr] lg:p-14">
