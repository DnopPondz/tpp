  ...
  return (
    <div className="theme-surface">
      <div className="mx-auto max-w-6xl space-y-16 px-6 pb-24 pt-20 lg:px-8">
        <header className="space-y-4 rounded-[3rem] border border-border-subtle bg-background p-10 text-center shadow-xl transition-colors duration-300">
        ...
        <section className="grid gap-6 rounded-[3rem] border border-border-subtle bg-background p-12 shadow-2xl transition-colors duration-300 lg:grid-cols-[1.2fr_1fr]">
          <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {copy.contactChannels.map((channel) => (
                <div key={channel.label} className="rounded-3xl border border-border-subtle bg-surface-muted/70 p-6 text-sm text-foreground transition-colors duration-300">
            ...
            <div className="rounded-3xl border border-dashed border-blue-200 p-6 text-sm text-foreground/80 transition-colors duration-300">
              <p className="font-semibold text-blue-700">{copy.projectPrepTitle}</p>
              <p className="mt-2">{copy.projectPrepDescription}</p>
            </div>
          </div>
          <div className="space-y-5 rounded-3xl border border-border-subtle bg-surface-muted/90 p-8 text-sm text-foreground/80 transition-colors duration-300">
        ...
        <section className="grid gap-6 rounded-[3rem] border border-border-subtle bg-background p-12 shadow-xl transition-colors duration-300 lg:grid-cols-2">
          <div className="space-y-4">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-full bg-surface-muted px-5 py-2 text-sm font-semibold text-blue-700 shadow transition hover:bg-surface-muted"
            >
              {copy.resourcesLink}
              <span aria-hidden>→</span>
            </Link>
          </div>
          <div className="rounded-3xl border border-border-subtle bg-background p-8 transition-colors duration-300">
            ...
            <form className="mt-6 space-y-3">
              ...
              <input
                ...
                className="w-full rounded-full border border-slate-300 px-4 py-3 text-sm shadow-sm outline-none transition focus:border-blue-400"
              />
              <button
                type="button"
