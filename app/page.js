  ...
  return (
    <div className="bg-slate-50">
      <div className="mx-auto max-w-6xl space-y-24 px-6 pb-24 pt-32 lg:px-8">
        <section className="relative overflow-hidden rounded-[3rem] border border-amber-100 bg-gradient-to-br from-amber-100 via-white to-slate-50 p-10 shadow-xl lg:p-14">
          <div className="pointer-events-none absolute -left-16 top-10 h-64 w-64 rounded-full bg-amber-200/40 blur-3xl" />
          <div className="pointer-events-none absolute -right-32 bottom-0 h-72 w-72 rounded-full bg-amber-300/30 blur-3xl" />
          <div className="relative z-10 grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <span className="inline-flex items-center rounded-full border border-amber-200 bg-white/60 px-4 py-1 text-xs font-semibold uppercase tracking-[0.3em] text-amber-600">
                  {brand.tagline}
                </span>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <button className="rounded-full border border-amber-300 bg-white px-6 py-3 text-base font-semibold text-amber-600 transition hover:border-amber-400 hover:text-amber-700">
                  {hero.secondaryCta}
                </button>
              </div>
              ...
              <ul className="grid gap-4 sm:grid-cols-2">
                {hero.highlights.map((highlight) => (
                  <li
                    key={highlight}
                    className="flex items-start gap-3 rounded-2xl border border-amber-100 bg-white/80 p-4 shadow-sm"
                  >
                    <span className="mt-1 inline-flex h-8 w-8 items-center justify-center rounded-full bg-amber-100 text-sm font-semibold text-amber-600">
                      ★
                    </span>
            ...
            <div className="relative">
              <div className="relative h-[26rem] overflow-hidden rounded-[2.5rem] border border-amber-100 bg-amber-50 shadow-2xl">
                ...
                <div className="absolute right-6 top-6 flex gap-2">
                  {slides.map((slide, index) => (
                    <button
                      ...
                      className={`h-2.5 w-8 rounded-full transition ${index === currentSlide ? "bg-white" : "bg-white/40 hover:bg-white/70"}`}
                      aria-label={`${index + 1} / ${slides.length}`}
                    />
                  ))}
                </div>

                <div className="pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-900/80 via-slate-900/40 to-transparent p-6 text-white" aria-live="polite">
                  <p className="text-xs font-semibold uppercase tracking-[0.4em] text-amber-200">{activeSlide?.label}</p>
          ...
          <div className="relative z-10 mt-10 grid gap-4 sm:grid-cols-3">
            {hero.metrics?.map((metric) => (
              <div
                key={metric.label}
                className="rounded-2xl border border-white/60 bg-white/80 p-4 text-center shadow-sm backdrop-blur"
              >
                <p className="text-3xl font-bold text-amber-600">{metric.value}</p>
        ...
        <section className="grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div className="space-y-6">
            <div className="space-y-3">
              <p className="text-sm font-semibold uppercase tracking-[0.25em] text-amber-600">{sections.about.title}</p>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              {sections.about.pillars.map((pillar) => (
                <div
                  key={pillar.title}
                  className="flex h-full flex-col gap-2 rounded-2xl border border-amber-100 bg-white p-5 shadow-sm"
                >
          ...
          <div className="relative flex h-full flex-col justify-center">
            <div className="relative overflow-hidden rounded-[2.5rem] border border-slate-200 bg-white/70 p-8 shadow-xl">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-100/70 via-transparent to-slate-100/60" />
              <div className="relative space-y-6">
                ...
                {activeSlide ? (
                  <div className="relative h-52 overflow-hidden rounded-3xl border border-amber-100 bg-amber-50">
                    <Image
        ...
        <section className="space-y-10 rounded-[2.5rem] border border-amber-100 bg-white p-10 shadow-xl lg:p-14">
          <div className="flex flex-col gap-3 text-center">
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-amber-600">{sections.capabilities.title}</p>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {sections.capabilities.items.map((item, index) => (
              <div
                key={item.title}
                className="flex h-full flex-col gap-4 rounded-3xl border border-amber-100 bg-amber-50/60 p-6 text-left shadow-sm"
              >
                <span className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-white text-base font-semibold text-amber-500">
                  {index + 1}
                </span>
                ...
                <span className="mt-auto text-xs font-semibold uppercase tracking-[0.2em] text-amber-500">
                  {brand.name}
                </span>
              </div>
            ))}
        ...
        <section className="space-y-8">
          <div className="flex flex-col gap-3 text-center">
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-amber-600">{sections.process.title}</p>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {sections.process.steps.map((step, index) => (
              ...
              >
                <span className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-amber-100 text-base font-semibold text-amber-600">
        ...
        <section className="space-y-10">
          <div className="flex flex-col gap-3 text-center">
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-amber-600">{sections.products.title}</p>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {sections.products.categories.map((category) => (
              <article
                key={category.title}
                className="relative overflow-hidden rounded-3xl border border-amber-100 bg-white p-6 shadow-sm"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-amber-100/40 via-transparent to-slate-100/40" />
                <div className="relative flex h-full flex-col gap-4">
                  <h3 className="text-xl font-semibold text-slate-900">{category.title}</h3>
                  <p className="text-sm leading-6 text-slate-600">{category.detail}</p>
                  <div className="mt-auto flex items-center gap-2 text-sm font-semibold text-amber-600">
                    <span>→</span>
        ...
        <section className="space-y-10">
          <div className="flex items-end justify-between gap-6">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.3em] text-amber-600">{sections.news.title}</p>
              <h2 className="mt-2 text-3xl font-semibold text-slate-900 sm:text-4xl">{brand.slogan}</h2>
            </div>
            <button className="hidden rounded-full border border-amber-300 px-5 py-2 text-sm font-medium text-amber-600 transition hover:border-amber-400 hover:text-amber-700 sm:block">
              {hero.secondaryCta}
            </button>
          </div>
          <div className="grid gap-6 md:grid-cols-2">
            {sections.news.articles.map((article) => (
              ...
              >
                ...
                <button className="mt-auto w-fit rounded-full border border-amber-300 px-4 py-2 text-sm font-medium text-amber-600 transition hover:border-amber-400 hover:text-amber-700">
                  {hero.secondaryCta}
                </button>
              </article>
            ))}
        ...
        <section className="grid gap-10 rounded-[3rem] border border-amber-100 bg-gradient-to-br from-white via-amber-50 to-amber-100 p-10 shadow-xl lg:grid-cols-[1.1fr_0.9fr] lg:p-14">
          <div className="space-y-6">
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-amber-600">{sections.contact.title}</p>
            <h2 className="text-3xl font-semibold text-slate-900 sm:text-4xl">{sections.contact.description}</h2>
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl border border-amber-200 bg-white p-5 shadow-sm">
                <p className="text-sm font-semibold uppercase tracking-[0.2em] text-amber-500">{sections.contact.phoneLabel}</p>
                <p className="text-base text-slate-700">+66 (0)2735 9109-10</p>
                <p className="text-base text-slate-700">+66 (0)2182 3306</p>
              </div>
              <div className="rounded-2xl border border-amber-200 bg-white p-5 shadow-sm">
                <p className="text-sm font-semibold uppercase tracking-[0.2em] text-amber-500">{sections.contact.emailLabel}</p>
                <p className="text-base text-slate-700">sales@thaipaipan.com</p>
                <p className="text-base text-slate-700">service@thaipaipan.com</p>
              </div>
            </div>
          </div>
          <div className="flex flex-col gap-5 rounded-3xl border border-white/60 bg-white/70 p-8 shadow-lg backdrop-blur">
            ...
            <button className="w-full rounded-full bg-amber-500 px-6 py-3 text-base font-semibold text-white shadow-lg transition hover:bg-amber-600">
              {sections.cta.button}
            </button>
          </div>
        </section>
