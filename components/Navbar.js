          ...
          <div className="flex items-center gap-2">
            <div className="hidden items-center gap-2 lg:flex">
              ...
              <button
                ...
                className="rounded-full border border-slate-200 px-4 py-1 text-sm font-medium text-slate-600 transition-colors hover:border-amber-300 hover:text-amber-600"
              >
