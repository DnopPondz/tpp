...
function LanguageToggleButton({ language, onToggle }) {
  ...
  return (
    <button
      type="button"
      onClick={onToggle}
      className="rounded-full border border-slate-700 bg-slate-900 px-4 py-1.5 text-sm font-semibold uppercase tracking-wide text-slate-200 shadow-sm transition-colors hover:border-blue-400 hover:text-blue-200"
...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-slate-800 bg-slate-950/90 backdrop-blur">
      <div className="hidden border-b border-slate-800 bg-slate-900/70 text-xs text-slate-300 md:block">
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-3 px-6 py-4 lg:px-8">
        <div className="flex items-center justify-between gap-6">
              ...
              return (
                <Link
                  ...
                  className={`rounded-full px-4 py-2 transition-all ${
                    isActive
                      ? "bg-blue-500/10 text-blue-200 shadow"
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-slate-700 text-slate-200 transition-colors hover:border-blue-400 hover:text-blue-200 lg:hidden"
        ...
        <div className="lg:hidden">
          <div
            id="mobile-menu"
            className={`grid origin-top gap-2 rounded-2xl border border-slate-700 bg-slate-900/95 text-sm font-medium text-slate-200 shadow-lg transition-all ${
              isMenuOpen
          ...
          >
              ...
              return (
                <Link
                  ...
                  className={`rounded-xl px-3 py-2 transition-colors ${
                    isActive
                      ? "bg-blue-500/20 text-blue-200 shadow"
                      : "hover:bg-slate-800 hover:text-blue-200"
                  }`}
                >
                  {translations.nav[item.key]}
            ...
            <div className="mt-2 flex items-center justify-between rounded-xl bg-slate-800/70 px-3 py-2">
            ...
            <div className="flex flex-col gap-1 rounded-xl bg-slate-800/70 px-3 py-2 text-xs text-slate-300">
